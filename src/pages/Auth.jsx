      ...
      <main className="relative z-10 flex flex-col items-center w-full px-4">
        ...
        <div className="bg-white p-10 sm:p-12 w-full max-w-[440px] rounded-sm shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)]">
          ...
          <div className="flex gap-8 border-b border-gray-100 mb-8">
            <button className="pb-3 text-[13px] font-bold text-[#1a55ff] border-b-2 border-[#1a55ff] tracking-wide">LOGIN</button>
            <button className="pb-3 text-[13px] font-bold text-gray-400 hover:text-gray-800 transition-colors tracking-wide">SIGN UP</button>
          </div>

          {/* تسجيل الدخول عبر المنصات */}
          <div className="flex gap-4 mb-8">
            <button className="flex-1 flex items-center justify-center gap-2 bg-[#f6f6f8] hover:bg-[#ececec] transition-colors py-3.5 rounded-[2px] text-[11px] font-bold tracking-wider text-gray-700">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="text-[9px] text-gray-400 font-bold tracking-[0.15em] uppercase">Or continue with email</span>
            <hr className="flex-1 border-gray-100" />
          </div>
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="mb-8">
              <label className="block text-[10px] font-bold text-gray-500 tracking-[0.15em] mb-2">EMAIL ADDRESS</label>
              <input 
                type="email" 
            ...
            <div className="mb-8 relative">
              <div className="flex justify-between items-end mb-2">
                <label className="block text-[10px] font-bold text-gray-500 tracking-[0.15em]">PASSWORD</label>
                <a href="#" className="text-[10px] font-bold text-[#1a55ff] hover:underline tracking-wider">FORGOT?</a>
              </div>
              <div className="relative flex items-center">
                <input 
                  type="password" 
                  defaultValue="secretpassword" 
                  className="w-full pb-3 text-xl text-gray-900 border-b border-gray-200 focus:outline-none focus:border-[#1a55ff] bg-transparent transition-colors tracking-widest font-mono" 
                />
                <button type="button" className="absolute right-0 bottom-4 text-gray-400 hover:text-gray-600">
          ...
          {/* الشروط والأحكام */}
          <p className="text-center text-[11px] text-gray-500 leading-relaxed max-w-[280px] mx-auto">
            By continuing, you agree to THE CURATOR'S <br />
